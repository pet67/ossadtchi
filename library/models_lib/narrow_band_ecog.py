...
def get_narrowband_features(X, frequency, fir_taps=257, abs_values_high_pass_frequency=0.5):
    ...
    b_hp_05, a_hp_05 = scipy.signal.butter(4, abs_values_high_pass_frequency, fs=frequency, btype='high')
...
def get_narrowband_features_flat(X, frequency):
    return library.models_lib.common.make_flat(get_narrowband_features(X, frequency))
